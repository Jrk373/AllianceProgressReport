...
VBP_Rep_Comb_validation_complete <- read_csv("./data/VBPQR_AllAPsCombined_Cleaned_complete_2023-10-31.csv")
...
Data.Period = "2023-09-30" #claimsAdjudicated Through Date
Reportasof = "2023-10-24" #Report as of date from VBP Quality report
ProgressReportDate = "2023-10-23" # Data that the VBPQR was released, or represents, usually the 1st of the month for the Progress Report
Members_Report_Date = "2023-10-31" #Date that the global members data was extracted
...
This report outlines Alliance Provider performance, areas of strengths and focus, and plans for improvement and advancement. Overall, Alliance performance improved over the last month, increasing it's level of performance above and beyond ALL the measure targets, including Follow Up After Hospitalization (FUH 7 Day), Anti-depressant Medication Management (AMM2), and Use of Opioids at High Dosage (HDO).
...
The Alliance, in close coordination with Health Choice, gathers member enrollment data from Health Choice databases, joining various data sources to compile a thorough and actionable active member roster. The roster is then distributed to each Alliance Provider by way of their respective Alliance Individualized Dashboards.
...
SELECT PrimaryID, BegDate, ProviderName
FROM RankedClaims
WHERE rn = 1
...
# write.csv(ActiveNAZMmbrshp, "./data/output/2023-10-31_ActiveNAZMembership.csv")
...
write.csv(CountyDistribution, "./data/output/2023-10-31_CountyDistribution.csv")
...
# Report Output
gtsave(Tab_CountyDistribution, filename = "./data/output/2023-10-31_Tab_CountyDistribution.png")
gtsave(Tab_CountyDistribution, filename = "./data/output/Tab_CountyDistribution.png")

# Dashboard
 gtsave(Tab_CountyDistribution, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/2023-10-31_Tab_CountyDistribution.png")
...
# Export the table as a csv for reference, Date is date of progress report
write.csv(Tab_Gender, "./data/output/2023-10-31_Tab_Gender.csv")
```
...
# Report Output
gtsave(Tab_GenderDistribution, filename = "./data/output/2023-10-31_Tab_GenderDistribution.png")
gtsave(Tab_GenderDistribution, filename = "./data/output/Tab_GenderDistribution.png")

# Dashboard
 gtsave(Tab_GenderDistribution, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/2023-10-31_Tab_GenderDistribution.png")
...
# Export the table as a csv for reference, Date is date of progress report
write.csv(DemoTable_SexByAgeGroup, "./data/output/2023-10-31_DemoTable_SexByAgeGroup.csv")
...
Fig_PopPyramid <- ggplot(DemoTable_SexByAgeGroup, aes(y = Age_Group, x = n, fill = sex)) +
  ...
  labs(
    ...
    subtitle = Members_Report_Date,
    caption = "Source: BCBSAZ Global Members, Extracted 2023-10-31") +
  theme_classic() +
  theme(
...
Report <- "./data/output/"
Report_FileName <- "2023-10-31_Fig_PopPyramid.png"
...
write.csv(ContractAlloc_v_Assignment, "./data/output/2023-10-31_ContractAlloc_v_Assignment.csv")
...
# Report Output
gtsave(Tab_Alloc_v_Assignment, filename = "./data/output/2023-10-31_Tab_Alloc_v_Assignment.png")
gtsave(Tab_Alloc_v_Assignment, filename = "./data/output/Tab_Alloc_v_Assignment.png")

# Dashboard
# gtsave(Tab_Alloc_v_Assignment, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/2023-10-31_Tab_Alloc_v_Assignment.png")
...
## First filter VBP_Rep_Comb for active alliance members

```{r}

AllianceEnrolledMembers <- read.csv("./data/AllianceEnrolledMembers.csv")

VBP_Rep_Comb_validation_complete$`Member ID` <- substr(VBP_Rep_Comb_validation_complete$`Member ID`, 4, nchar(VBP_Rep_Comb_validation_complete$`Member ID`))

VBP_Rep_Comb_validation_MembersOnly <- VBP_Rep_Comb_validation_complete |> 
  filter(`Member ID` %in% AllianceEnrolledMembers$AhcccsId)
...
Tab_PercentCompliant <- VBP_Rep_Comb_validation_MembersOnly |> 
...
# Export the table as a csv for reference, date is date of progress report
write.csv(Tab_PercentCompliant, "./data/output/2023-10-31_Tab_PercentCompliant.csv")
...
gt() |> 
  ...
  cols_label(SubMeasureID = "NCQA Measure",
   ...
   #           ) |>
  tab_source_note(
    source_note = md("*SOURCE: BCBSAZ VBP Performance Reports, Claims Adjudicated Through 2023-09-30* </br> *FUM not required by contract*")
  ) |> 
  tab_style(
    style = list(
      cell_fill(color = "#440154"),
...
# Report Output
gtsave(Tab_AllProvPerformance, filename = "./data/output/2023-10-31_Tab_AllProvPerformance.png")
gtsave(Tab_AllProvPerformance, filename = "./data/output/Tab_AllProvPerformance.png")

# Dashboard
# gtsave(Tab_AllProvPerformance, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/2023-10-31_Tab_AllProvPerformance.png")
...
# 
# write.csv(Tab_AllProvLollipop, "./data/output/2023-10-31_Tab_AllProviderLollipop.csv")
# 
...
# # Set the file path and name for saving the .png file
# Report <- "./data/output/"
# Report_Filename <- "2023-10-31_Fig_AllProvLollipop.png"
# 
# Dashboard <- "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/"
# Dashboard_FileName1 <- "2023-10-31_Fig_AllProvLollipop.png"
...
write.csv(Tab_AllProvLollipop, file = "./data/output/2023-10-31_Tab_AllProviderLollipop.csv")
...
Fig_AllProvLollipop <- ggplot(Tab_AllProvLollipop, aes(x = Provider_ShortName, y = PercentCompliant)) +
  ...
  labs(title = "Alliance Provider Target Measure Compliance",
       subtitle = "With Percent of Total Eligible Participants",
       caption = "Data source: BCBSAZ VBP Report, Claims Adjudicated Through 2023-10-31")

# Save the ggplot as a .png file
ggsave(file = "./data/output/2023-10-31_Fig_AllProvLollipop.png", plot = Fig_AllProvLollipop, width = 6, height = 4, dpi = 300)
...
write.csv(IndivAlliancePerformance_AMM2, "./data/output/2023-10-31_IndivAlliancePerformance_AMM2.csv")
```
...
# Report Output
gtsave(Tab_IndivAlliancePerformance_AMM2, filename = "./data/output/2023-10-31_Tab_IndivAlliancePerformance_AMM2.png")
gtsave(Tab_IndivAlliancePerformance_AMM2, filename = "./data/output/Tab_IndivAlliancePerformance_AMM2.png")

# Dashboard
# gtsave(Tab_IndivAlliancePerformance_AMM2, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/2023-10-31_Tab_IndivAlliancePerformance_AMM2.png")
...
write.csv(IndivAlliancePerformance_FUH7, "./data/output/2023-10-31_IndivAlliancePerformance_FUH7.csv")
```
...
# Report Output
gtsave(Tab_IndivAlliancePerformance_FUH7, filename = "./data/output/2023-10-31_Tab_IndivAlliancePerformance_FUH7.png")
gtsave(Tab_IndivAlliancePerformance_FUH7, filename = "./data/output/Tab_IndivAlliancePerformance_FUH7.png")

# Dashboard
# gtsave(Tab_IndivAlliancePerformance_FUH7, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/2023-10-31_Tab_IndivAlliancePerformance_FUH7.png")
...
write.csv(IndivAlliancePerformance_HDO, "./data/output/2023-10-31_IndivAlliancePerformance_HDO.csv")
```
...
# Report Output
gtsave(Tab_IndivAlliancePerformance_HDO, filename = "./data/output/2023-10-31_Tab_IndivAlliancePerformance_HDO.png")
gtsave(Tab_IndivAlliancePerformance_HDO, filename = "./data/output/Tab_IndivAlliancePerformance_HDO.png")

# Dashboard
# gtsave(Tab_IndivAlliancePerformance_HDO, filename = "C:/Users/KGLtd/OneDrive - The NARBHA Institute/Site Assets/SitePages/Alliance-Dashboard/2023-10-31_Tab_IndivAlliancePerformance_HDO.png")
