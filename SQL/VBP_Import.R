...
vbp_cbi <-    read_xlsx("./data/VBPReports/Quality/vbpbhh_report_2023-02-23_94-2880847_Community_Bridges_HCA_BHH_VBP_Quality.xlsx", sheet = "Detail")
vbp_cpih <-   read_xlsx("./data/VBPReports/Quality/vbpbhh_report_2023-02-23_86-0215065_Change_Point_Integrated_Health_HCA_BHH_VBP_Quality.xlsx", sheet = "Detail")
vbp_lcbhc <-  read_xlsx("./data/VBPReports/Quality/vbpbhh_report_2023-02-23_86-0250938_Little_Colorado_Behavioral_Health_HCA_BHH_VBP_Quality.xlsx", sheet = "Detail")
vbp_mmhc <-   read_xlsx("./data/VBPReports/Quality/vbpbhh_report_2023-02-23_86-0214457_Mohave_Mental_Health_HCA_BHH_VBP_Quality.xlsx", sheet = "Detail")
vbp_ph <-     read_xlsx("./data/VBPReports/Quality/vbpbhh_report_2023-02-23_86-0206928_Polara_Health_HCA_BHH_VBP_Quality.xlsx", sheet = "Detail")
vbp_sbhs <-   read_xlsx("./data/VBPReports/Quality/vbpbhh_report_2023-02-23_86-0290033_Southwest_Behavioral_Health_HCA_BHH_VBP_Quality.xlsx", sheet = "Detail")
vbp_shg <-    read_xlsx("./data/VBPReports/Quality/vbpbhh_report_2023-02-23_86-0207499_Spectrum_Health_Group_HCA_BHH_VBP_Quality.xlsx", sheet = "Detail")
vbp_tgc <-    read_xlsx("./data/VBPReports/Quality/vbpbhh_report_2023-02-23_86-0223720_The_Guidance_Center_HCA_BHH_VBP_Quality.xlsx", sheet = "Detail")
...
VBP_Rep_Comb <- VBP_Rep_Comb %>% 
  ...
  mutate(AdaptedNCQAMean = ifelse(SubMeasure.ID == "AMM2", 57.29,
                                     ifelse(SubMeasure.ID == "FUH7", 39.36, 
                                            ifelse(SubMeasure.ID == "HDO", "93.00", NA)
                                     ))) %>% 
  select(Data.Period,
         Provider_Shortname,
         Health.Home.Name,
...
write.csv(VBP_Rep_Comb, "C:/Users/KGLtd/OneDrive - The NARBHA Institute/ACO/Data and Reports/BCBS-HCA Reports/VBPReports/data_original_vbpbhh_2023-02-23_allProvidersCombined.csv")
write.csv(VBP_Rep_Comb, "./data/VBPReports/Quality/data_original_vbpbhh_2023-02-23_allProvidersCombined.csv")
#export to Backup Folder
write.csv(VBP_Rep_Comb, "C:/Users/KGLtd/OneDrive/R_Studio/progressReport/data/datadata_original_vbpbhh_2023-02-23_allProvidersCombined.csv")
